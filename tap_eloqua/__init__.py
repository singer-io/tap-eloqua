...
REQUIRED_CONFIG_KEYS = ["start_date", "client_id", "client_secret", "refresh_token", "redirect_uri"]
...
def parse_args(required_config_keys):
    ...
    parser.add_argument("-dev", "--dev", action="store_true", help="Runs tap in dev mode")
